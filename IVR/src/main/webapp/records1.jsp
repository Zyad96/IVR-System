<%-- 
    Document   : records1
    Created on : Jul 3, 2023, 4:55:21 PM
    Author     : aisha
--%>
...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <input class="form-control bg-dark border-0" type="search" id="searchInput" placeholder="Search">
    </form>
          <script>
    ...
    searchInput.addEventListener('input', function() {
        ...
        tableRows.forEach(function(row) {
            const callerNumber = row.querySelector('td:nth-child(2)').textContent.toLowerCase();
            
            // If the caller number contains the search term, show the row, otherwise hide it
            if (callerNumber.includes(searchTerm)) {
                row.style.display = '';
            } else {
...
<!--  <%
// Assuming you're using JDBC for database connectivity
// Make sure to include the necessary JDBC driver in your project

// Import the required Java classes


// Database connection details
String jdbcURL = "jdbc:postgresql://localhost:5432/iti";
String dbUser = "postgres";
String dbPassword = "139148";
...
<div class="bg-secondary rounded h-100 p-4">
    <h3 style="color: red" class="mb-4">Call Records</h3>
    ...
    audio::-webkit-media-controls-panel {
        background-color: red; /* Set the background color of the media controls panel to black */
    }

    audio::-webkit-media-controls-play-button,
    audio::-webkit-media-controls-pause-button {
        color: red; /* Set the color of the play and pause buttons to red */
    }
